...
const Footer = () => {
  return (
    <footer className="bg-[#05050585] p-2 lg:text-base md:text-md text-xs text-center mt-auto font-montserrat">
      ...
      <div className="flex flex-col justify-center items-center gap-2">
        ...
        <div className="flex justify-center items-center gap-5 lg:gap-8 pb-4">
          ...
          <a href="mailto:shehzansheikh0@gmail.com" target="_blank">
            <img src="./mail.svg" width="20" className="w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8" />
          </a>
        </div>
      </div>
