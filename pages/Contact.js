  ...
  return (
    <>
      ...
      <div className='flex justify-center items-center mt-auto mb-auto'>
        <div className="w-[80%] lg:w-[60%] bg-[#05050585] p-4 text-[#efb961] rounded-lg text-sm lg:text-base lg:mt-2 mt-8">
          ...
          <div className="mt-5 text-lg">
            ...
            <p className="mt-2 text-center">Follow us on social media:</p>
